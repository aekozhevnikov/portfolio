...
export default defineConfig((ctx) => {
    ...
    return {
        ...
        extras: [
            // 'ionicons-v4',
            // 'mdi-v7',
            'fontawesome-v6', // добавляем Font Awesome
            // 'eva-icons',
            // 'themify',
            // 'line-awesome',
        ...
        build: {
            ...
            publicPath: process.env.DEV ? '/' : '/portfolio/',
            // analyze: true,
            env: envVars.data,
            // envFilter:
            ...
            // Disabled vite-plugin-checker to avoid ESLint errors during build
            // [
            //     'vite-plugin-checker',
            //     {
            //         vueTsc: true,
        ...
        ssr: {
            ...
            // (gets superseded if env.PORT is specified at runtime)
